...
width = "medium";
wheelSize = "large";
wheelShape = "spherical";
boltsColor = "black";
foldable = true;
bodyColor = "blue";
truckColor = "black";
wheelColor = "blue";
bodyDecorationShape = "triangle";
bodyDecorationColor = "black";
bodyDecorationSize = "large";
wheelDecoration = false;
bodyGridTapeSize = "fit";
bodyGridTapeColor = "black";
bodyRailsColor = "black";
bodyRailsSize = "short";
truckRisersSize = "medium";
truckRisersColor = "black";
